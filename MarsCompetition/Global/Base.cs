...
namespace MarsCompetition.Global
{
    public class Base
    {
        ...
        public static string excelPath = System.IO.Directory.GetParent(@"../../../").FullName + "/TestLibrary/TestData/TestData.xlsx";
        public static string ScreenshotPath = System.IO.Directory.GetParent(@"../../../").FullName + "/TestLibrary/Screenshots/";
        public static string ReportPath = System.IO.Directory.GetParent(@"../../../").FullName + "/TestLibrary/Reports/";
        ...
        protected void ExtentStart()
        {
            ...
            string reportName = System.IO.Directory.GetParent(@"../../../").FullName + Path.DirectorySeparatorChar + "TestLibrary/TestReports" + Path.DirectorySeparatorChar + "Report_" + DateTime.Now.ToString("_dd-MM-yyyy_HHmm") + Path.DirectorySeparatorChar;
        ...
        public void TearDown()
        {
            ...
            var errorMessage = string.IsNullOrEmpty(TestContext.CurrentContext.Result.Message)? "" : string.Format("{0}", TestContext.CurrentContext.Result.Message);
